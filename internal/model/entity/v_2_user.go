...
type V2User struct {
	...
	CommissionType    int         `json:"commission_type"    orm:"commission_type"    ` // 0: system 1: period 2: onetime
	...
	LastLoginIp       string      `json:"last_login_ip"      orm:"last_login_ip"      ` // 最后登入ip
	...
	ExpiredAt         *gtime.Time `json:"expired_at"         orm:"expired_at"         ` // 到期时间
